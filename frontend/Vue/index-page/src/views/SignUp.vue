        ...
        <div id="sign-up" class="text-center"> 
            ...
            <div id="modal-area">
                <transition>
                    ...
                    >
                        <div id="icon-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="55" height="40" viewBox="0 0 75 60">
                                <path id="user-plus-solid" d="M73.125,24.375h-7.5v-7.5A1.881,1.881,0,0,0,63.75,15H60a1.881,1.881,0,0,0-1.875,1.875v7.5h-7.5A1.881,1.881,0,0,0,48.75,26.25V30a1.881,1.881,0,0,0,1.875,1.875h7.5v7.5A1.881,1.881,0,0,0,60,41.25h3.75a1.881,1.881,0,0,0,1.875-1.875v-7.5h7.5A1.881,1.881,0,0,0,75,30V26.25A1.881,1.881,0,0,0,73.125,24.375ZM26.25,30a15,15,0,1,0-15-15A15,15,0,0,0,26.25,30Zm10.5,3.75H34.793a20.4,20.4,0,0,1-17.086,0H15.75A15.754,15.754,0,0,0,0,49.5v4.875A5.626,5.626,0,0,0,5.625,60h41.25A5.626,5.626,0,0,0,52.5,54.375V49.5A15.754,15.754,0,0,0,36.75,33.75Z" fill="#f7b74a"/>
                            </svg>
                        </div>
