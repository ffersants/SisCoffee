    ...
    <modal-default class="text-center"  :widthRef="modalWidth">
        ...
        <hr>
            <b-row id="second-row" class="text-center">
                <b-col cols="6">
                    <div>
                        <input placeholder="Usuário" id="admUser" type="text">
                ...
                <b-col cols="6">
                    <div>
                        <input placeholder="Senha" id="admPswd" type="password">
                        <label for="admPswd">Senha</label>
                    </div>
                </b-col>
            </b-row>
